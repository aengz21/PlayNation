...
<div class="col-md-3 col-7">
    <a href="<?= base_url() ?>" class="text-decoration-none d-flex flex-column align-items-center">
        <img src="<?= base_url('assets/favicon/ikon.png') ?>" alt="logo"
             class="img-fluid" style="width: 9%; height: auto;">
        <span class="logo mt-2" style="font-size: 0.85rem; color: rgba(255, 255, 255, 0.6);">
            <?= $settings->nama_toko; ?>
        </span>
    </a>
</div>

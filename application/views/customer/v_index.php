                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        <?php foreach ($category as $key => $value) { ?>
                            <a href="<?= base_url('store/kategori/' . $value->id); ?>" class="list-group-item shadow-sm font-weight-bold text-decoration-none text-dark">
                                <img src="" style="width:35px"> <?= $value->kategori; ?>
                ...
                <div class="card h-100 border-0 shadow rounded-md">
                    ...
                    <div class="card-body">
                        ...
                        <div class="discount mt-2" style="color: #999">
                            <s>Rp. <?= number_format($value->price); ?></s>
